...
This list has been updated on a frozen code on 2018-09-05 after merged commit fad88e18a9795b377676ad6f63c1772868e0d761 (Wallet RPC version 1.3), and at block height 1643308.
...
* *fee* - Integer value of the fee charged for the txn (not implemented, will be removed soon, return 0).
* *tx_blob* - Raw transaction represented as hex string (not implemented, will be removed soon).
* *tx_hash* - String for the publically searchable transaction hash.
* *tx_key* - String for the transaction key (not implemented, will be removed soon).
...
* *standard_address* - string; Destination public address.
