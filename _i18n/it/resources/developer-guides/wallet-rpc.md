...
This list has been updated on a frozen code on 2018-08-20 after merged commit b780cf4db1f9dfc49e7f16afc47892a5b40fe68a (Wallet RPC version 1.2), and at block height 1643308.
...
* *fee* - Integer value of the fee charged for the txn (not implemented yet, return 0).
* *tx_blob* - Raw transaction represented as hex string (not implemented yet).
* *tx_hash* - String for the publically searchable transaction hash.
* *tx_key* - String for the transaction key (not implemented yet).
