...
**A:** _A new release will be announced before the network upgrade (around 17th September). You will only have to be using the updated software by the time the network upgrade occurs (17th October). To the end user, it will be like a simple software update._
