...
Regardless of the number of outputs in a transaction, the corresponding Bulletproofs+ range proof is _96 bytes_ smaller than a Bulletproofs range proof.
...
However, it's worth noting that a 2-output Bulletproofs+ range proof (the most common) generates _10.2%_ faster!
...
_Thanks to Mortanta Manolete for designing the Bulletproofs+ logo!_
