...
**\<sgp\_\>** koe: nice list! koe_9 may be controversial since spending pre-rct would stand out more, no?  
...
**\<Isthmus\>** This is 80% a joke: We implement Koe_9 and sgp_coinbase_only rings, \*but\* require each and every one to include N coinbases and M pre-ringCT transactions, for fixed consensus parameters N and M  
...
**\<atoc\>** (y)  
**\<koe\>** sure I can put on research github; was just wondering if koe_11 should go on main repo's issues  
