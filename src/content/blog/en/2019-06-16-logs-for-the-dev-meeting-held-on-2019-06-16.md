...
**\<sgp\_>** rehrar: I have personally head some arguments against removing tx_extra from legacy financial services  
...
**\<sgp\_>** ftr I only support parsing for current payment ID behavior to force services to switch. I am not for the removal of tx_extra in its entirety  
...
**\<sgp\_>** When I was doing payment ID research back in January, someone specifically asked that tx_extra remained for this flexibility  
...
**\<sgp\_>** dEBRUYNE: I understand, I just personally think there is some middle ground that doesn't need to include full tx_extra. I think we've exhausted this topic for now  
**\<dEBRUYNE>** Currently, we removed it, but it is easily to reenable  
**\<sgp\_>** \*full tx_extra removal  
