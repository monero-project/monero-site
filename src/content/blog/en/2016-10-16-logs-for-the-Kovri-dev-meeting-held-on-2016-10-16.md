...
**\<i2p-relay> {-anonimal}** (the issue is probably _when client doesn't have everything it wants when router expects inbound peers_)  
...
**\<i2p-relay> {-anonimal}** moneromooo: ok, scenario question: what if we _can_ get a reliable connection but syncing has to wait for it but will be notified "try again in X minutes". Will that break monero?  
...
**\<i2p-relay> {-anonimal}** _ one more thing  
...
**\<i2p-relay> {-anonimal}** _ would navigate but you know MRL better than I  
