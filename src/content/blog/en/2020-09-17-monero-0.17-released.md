...
This is the v0.17.0.0 release of the Monero software. This major release is due to the [October 17th network upgrade](/blog/2020/08/18/network-upgrade-october-2020/), which in turn adds support for the [CLSAG transaction format](/blog/2020/07/31/clsag-audit/) which improves verification speed and reduces transaction size.
