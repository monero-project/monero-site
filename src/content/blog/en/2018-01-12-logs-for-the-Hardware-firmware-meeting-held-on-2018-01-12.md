...
**\<msvb-mob>** For example ed25519_valid_sig (validate signature) is a function.  
...
**\<luigi1111w>** or a simple scalarmult_base if you have that  
...
**\<cslashm>** _and easly_ (end of day in FR :) )  
...
**\<cslashm>** yes for each txes. basically scan involves get_key_derivation and generate_key_image, those two op are done by the device. The rest is done by the PC as usual  
