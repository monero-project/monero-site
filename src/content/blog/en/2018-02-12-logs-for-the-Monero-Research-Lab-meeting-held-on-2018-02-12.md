...
**\<suraeNoether>** hyc so i take it the fiddle is only _mythically_ hypnotic, not literally, then?  
...
**\<hyc>** nice  
**\<sarang>** gingeropolous: I absolutely do not want to plan a conference 0_0  
**\<suraeNoether>** sarang \^  
**\<gingeropolous>** noice  
