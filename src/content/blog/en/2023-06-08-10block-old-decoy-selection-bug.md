...
Not to beat a dead horse, echoing j-berman in his [original decoy selection bug post-motem](/blog/2021/09/20/post-mortem-of-decoy-selection-bugs/): "anyone with a background in statistics and probability theory is encouraged to join in discussions geared toward improving the algorithm." In hindsight, this bug could have been discovered if the statistical distributions had been analyzed carefully.
