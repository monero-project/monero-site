...
**\<anonimal>** _But_ it's all needed, especially the testnet, so it all works out in the end.  
**\<MoroccanMalinois>** That's exactly what i hated most when i had a company (with employees)  
**\<anonimal>** Note: billable hours _doesn't_ include the all the time at my machine when working on the project (most, but not all)  
