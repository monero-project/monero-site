...
[The latest CLI release notes can be found on the precedent blog post](/blog/2025/08/26/monero-0.18.4.2-released/)

Some highlights of this release are:

- Fix privacy leak with malicious remote node. For a detailed report, read [Post mortem of `find_and_save_rings()` bug](/blog/2025/08/26/post-mortem-of-find-and-save-rings-bug/)
