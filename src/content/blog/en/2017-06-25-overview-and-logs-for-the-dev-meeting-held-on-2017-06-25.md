...
**\<knaccc>** 2017-06-23 12:54:59 surae well, if raising the ring size from 3 to 20 results in 15% larger transactions, i have _no_ problem endorsing increased minimum mix-ins _even without_ taking churning into account. i've advocated that since the chain reaction paper, but lacking a specific attack vector, it was hard to justify the cost...  
