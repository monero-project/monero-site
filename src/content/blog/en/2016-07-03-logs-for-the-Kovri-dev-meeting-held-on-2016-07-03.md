...
**\<**uguu**>** i2p needs a better udp transport  
...
**\<meeting-bot> [EinMByte]** **uguu**: It probably does, so let's hope SSU2 will be better  
...
**\<meeting-bot> [anonimal]** _but_ I also may start drafting a FFS proposal for a chunk of that time (I said I would last meeting). We'll see.  
...
**\<meeting-bot> [anonimal]** Kimai is a horrid _#()_@#)$@#$#@  
