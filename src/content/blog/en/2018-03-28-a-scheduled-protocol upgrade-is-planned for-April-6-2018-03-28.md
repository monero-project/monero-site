...
**Note that this is a scheduled and consensual network upgrade. Thus, unlike the BCH / BTC split, a new coin _won't_ be created.**
...
1. Download the new binaries from [the official website](/downloads/) or [Github](https://github.com/monero-project/monero/releases/tag/v0.12.0.0).
...
1. Download the new binaries from [the official website](/downloads/) or [Github](https://github.com/monero-project/monero-gui/releases/tag/v0.12.0.0).
