...
_NOTE: Setting a password or changing any settings in config.json will create a separate sidechain. Only do this if you know what you're doing._

### Getting Started

- [P2Pool Download](https://github.com/SChernykh/p2pool/releases)
- [P2Pool GitHub](https://github.com/SChernykh/p2pool)
- [P2Pool Monitoring Page](https://p2pool.io/) _Note since P2Pool is decentralized, this is only a monitoring page._
