...
**\<i2p-relay> {-meeting-bot} [anonimal]** _Poof!_ done.  
...
**\<i2p-relay> {-meeting-bot} [anonimal]** No problem guzzi, thank _you_ for your great progress.  
...
**\<i2p-relay> {-meeting-bot} [fluffypony]** Jake**: this is the Kovri meeting  
**\<i2p-relay> {-meeting-bot} [fluffypony]** you can ask later  
\*\*\<i2p-relay> {-meeting-bot} [Jake**]** Nvm  
...
**\<i2p-relay> {-meeting-bot} [anonimal]** The packaging aspect alone will be 'fun' to deal with, _especially_ come upgrade time.  
...
**\<i2p-relay> {-fluffypony}** _ eyes his beer  
...
**\<i2p-relay> {-meeting-bot} [anonimal]** _If_.  
