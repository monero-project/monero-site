...
**\<tewinget>** ok, so far I've got cryptonote::classes to/from json for a majority of what will need to be serialized for RPC. I have a couple of RPC calls actually written and working via ZMQ (get*height get_transactions, and key_images_spent)  
...
\*\*\<neosilky*>** I had to merge them to get the repo to compile as GCC 6.1 is default for Arch  
**\<fluffypony>** kk  
...
**\<neosilky\_>** Yep, only needed #846. @tewinget should enable testing repo too :)  
