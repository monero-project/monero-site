...
**\<Isthmus\>** Apparently unlock_time supports both unix timestamps and height... There are 13 transactions that used UNIX time and the rest are height-based  
...
**\<moneromooo\>** I'm thinking in particular of the fact monero's unlock_time semantics do not match bitcoin's, and bitcoin's used for more fancy things like atomic swaps.  
**\<sarang\>** Ah ok  
