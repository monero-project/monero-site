...
**\<suraeNoether>** long story short, it's a simple change from computing keys as a simple sum(key) to sum( H(key, list_of_keys)\*key)  
...
**\<suraeNoether>** gotta _have_ a good red team  
...
**\<suraeNoether>** they _do_ have wifi  
**\<suraeNoether>** just not _great_ wifi  
