...
**\<hyc>** which?  
**\<moneromooo>** tx*{unlocks,heights,outputs}  
**\<hyc>** ah  
**\<moneromooo>** And output*{keys,amounts,indices,txs}  
...
**\<fluffypony>** not necessary to read the style guide now, just more a general sense of if everyone is comfy with _a_ style guide, and if anyone has any particular preferences  
