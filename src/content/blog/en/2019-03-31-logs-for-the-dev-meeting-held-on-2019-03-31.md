...
**\<sarang>** It's the output_lineup method from these simulations: https://github.com/SarangNoether/skunkworks/blob/outputs/outputs/simulate.py  
...
**\<oneiric\_>** sarang: select_lineup? #L128  
