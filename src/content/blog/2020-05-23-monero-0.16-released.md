...
This is the v0.16.0.0 major release of the Monero software. This major release adds [Dandelion++](/2020/04/18/dandelion-implemented.html) support and improves Bulletproofs verification speed.
...
The new binaries can be downloaded from the [Downloads page](/downloads) or from the direct links below.
