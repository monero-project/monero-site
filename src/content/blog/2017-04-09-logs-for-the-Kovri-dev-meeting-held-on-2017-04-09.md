...
**\<anonimal>** d. That lead me to the unmaintainable mess of our forked RI implementation, which has been neglected, so now at a minimum I'm working on a RI parser/reader/writer refactor. From there, unit-test _and then_ back to NTCP so I can close that damn milestone issue >:|  
...
**\<anonimal>** (well, I'm hoping FF will move faster but it sounds like they're at least _moving_)  
...
**\<i2p-relay> [gingeropolous]** and they _just_ happen to know a _whole_ lot about everything  
...
**\<i2p-relay> [gingeropolous]** just go full Mr. Robot. Loose touch with reality, veer into psychosis, and then even _you_ don't know who you are.  
...
**\<anonimal>** Alright. From there we should raise the funds first and _then_ start inviting hackers on H1.  
**\<anonimal>** Any agreements/disagreements?  
**\<sgp>** I agree  
**\<anonimal>** Btw, many hackers are already _on_ H1, by invite I mean invite to start looking at our projects.  
