...
**\<meeting-bot> [anonimal]** pero: how about this: can you whip up another sample for after the meeting but _only_ exo2 and lato and doing various sizes that you think are appropriate?  
...
**\<meeting-bot> [anonimal]** 6. #337 https://geti2p.net/en/docs/naming  
**\<meeting-bot> [anonimal]** What happens is that any addresses that are saved with an addresshelper are simply inserted into ./addressbook but not user*hosts.txt (or similar)  
...
**\<meeting-bot> [i2p-relay] {-moneromooo}** To the extent I know of how CN uses the network... -*- :D  
**\<fluffypony>** yes  
