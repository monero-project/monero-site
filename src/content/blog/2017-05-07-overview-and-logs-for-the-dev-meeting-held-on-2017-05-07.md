...
**\<moneromooo>** Older wallets _might_ create txes which aren't relayed by newer daemons.  
...
**\<fluffypony>** moneromooo: I thought about that, but it's a single daemon that _should_ exist in the repo alongside the wallet RPC etc.  
...
**\<endogenic>** oooh  
**\<tewinget>** anyway, I have the daemon's side of the code rebased and _nearly_ ready to PR and merge. I mean, it could be merged now, but I should clean it up a little/address a few more of the comments on the existing PR first.  
