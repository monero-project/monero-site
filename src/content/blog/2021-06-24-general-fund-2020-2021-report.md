...
Also worth noting that non-monetary donations are made by some companies who are currently paying for some of our infrastructure (see [the 'Sponsorships' page](/community/sponsorships/)). Without them, the cost of resources such as our website hosting, the CDN and its associated bandwidth, etc, would probably be above 10k$/month, so it's effectively saving the general fund this amount every month.
