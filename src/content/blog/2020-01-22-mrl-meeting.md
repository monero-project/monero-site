...
**\<sarang\>** Hold on  
**\<Isthmus\>** Discovered that everybody seems to use the miner_tx differently, including some really strange stuff like many blocks with 60 B of null padding(??!) https://xmrchain.net/tx/7dfcc4e5d8bd772e3373e51d4140052121503d9b4f3cb6587251292bf06ced9a  
...
**\<Isthmus\>** \*each spending from a coinbase whose miner tx_extra has...  
...
**\<Isthmus\>** Other two things on the agenda - encrypted unlock time, and tx_extra in coinbases  
...
**\<Isthmus\>** Everybody seems to use the miner_tx differently, including some really strange stuff like many blocks with 60 B of null padding(??!) https://xmrchain.net/tx/7dfcc4e5d8bd772e3373e51d4140052121503d9b4f3cb6587251292bf06ced9a  
