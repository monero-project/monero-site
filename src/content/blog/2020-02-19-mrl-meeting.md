...
**\<sarang\>** Major caveat: these assume the same input/output distribution as the current chain, and are \_estimates_only\_  
...
**\<sarang\>** ^ verification time estimate for \_group_operations_only\_ at varying ring sizes  
