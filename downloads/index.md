            ...
            <div class="info-block">
                <h2 id="mobilelight">{% t downloads.mobilelight %}</h2>
                    <div class="row">
                        ...
                        <tr>
                            <td><img class="small" src="/img/monfluo.png" width="100" height="100" loading="lazy" alt="Monfluo logo"><a href="https://codeberg.org/Monfluo/monfluo-android/releases/latest">Monfluo</a></td>
                            <td><span class="icon-android"></span></td>
                            <td>X</td>
                            <td><a class="ext-noicon" href="https://codeberg.org/Monfluo/monfluo-android" aria-label="GitHub icon" target="_blank"><span class="icon-github"></span></a></td>
                        </tr>
                        <tr>
                        ...
                        <div class="row between-xs mob-wallets mobile-only">
                            ...
                            <ul>
                                ...
                                <li><a class="ext-noicon" href="https://codeberg.org/Monfluo/monfluo-android/releases/latest" aria-label="Monfluo icon" target="_blank"><img class="mob" src="/img/monfluo.png" width="100" height="100" loading="lazy" alt="Monfluo Logo">Monfluo</a></li>
