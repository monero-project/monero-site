            ...
            <div class="info-block">
                <h2 id="mobilelight">{% t downloads.mobilelight %}</h2>
                    <div class="row">
                        ...
                        <tr>
                            <td><img class="small" src="/img/ANONERO.png" width="100" height="100" loading="lazy" alt="ANONERO logo"><a href="https://anonero.io/">ΛИ0ИΞR0</a></td>
                        ...
                        <div class="row between-xs mob-wallets mobile-only">
                            ...
                            <ul>
                                <li><a class="ext-noicon" href="https://anonero.io" aria-label="ANONERO icon" target="_blank"><img class="mob" src="/img/ANONERO.png" width="100" height="100" loading="lazy" alt="ANONERO Logo">ΛИ0ИΞR0</a></li>
