                        ...
                        <div class="row">
                            ...
                            <p>{% t downloads.hwdesc %}</p>
                                ...
                                <tr>
                                    ...
                                    <td><img src="/img/emojis/274C.svg" alt="{% t downloads.redcrossalt %}"></td>
                                </tr>
                                <tr>
                                    ...
                                    <td><img src="/img/emojis/2714.svg" alt="Check mark"></td>
                                </tr>
                                </table>
                                <div class="mobile-only">
                                    <div>
                                    ...
                                    <ul>
                                        ...
                                        <b>{% t downloads.hwthsupported %}:</b>
                                            ...
                                            <li>Monero CLI</li>
                                            <li>Monerujo</li>
                                        <b>{% t downloads.hwthopen %}:</b> 
                                            <li>{% t downloads.hwno %}</li>
                                    </ul>
