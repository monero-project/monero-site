...
The Maximum A Posteriori (MAP) Decoder attack, first described by Aeeneh et al. (2021)[^2], leverages the difference between Monero's real spend distribution and its decoy distribution. Using the MAP Decoder attack and the real spend distribution estimated in the OSPEAD research, an anti-privacy adversary has a 1-in-4.2 probability of correctly guessing the real spend at current ring size of 16.
